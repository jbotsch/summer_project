...
exports.search = function(req, res) {
  ...
  setTimeout(function() { res.end(JSON.stringify({'score': highestScore, 'choice': highestChoice, 'lowestScore': score, 'otherChoice' : choices[i]})) }, 5000);	
};
